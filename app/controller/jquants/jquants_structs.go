...
type jquantsPriceInfo struct {
	Date                      string  `json:"Date"`      // 日付
	Code                      string  `json:"Code"`      // 銘柄コード
	// Open                      string  `json:"O"`         // 始値（調整前）
	// High                      string  `json:"H"`         // 高値（調整前）
	// Low                       string  `json:"L"`         // 安値（調整前）
	// Close                     string  `json:"C"`         // 終値（調整前）
	// UpperLimit                string  `json:"UL"`        // 日通ストップ高を記録したか、否かを表すフラグ
	// LowerLimit                string  `json:"LL"`        // 日通ストップ安を記録したか、否かを表すフラグ
	// Volume                    string  `json:"Vo"`        // 取引高（調整前）
	// TurnoverValue             string  `json:"Va"`        // 取引代金
	...
	// MorningOpen               string  `json:"MO"`        // 前場始値
	// MorningHigh               string  `json:"MH"`        // 前場高値
	// MorningLow                string  `json:"ML"`        // 前場安値
	// MorningClose              string  `json:"MC"`        // 前場終値
	// MorningUpperLimit         string  `json:"MUL"`       // 前場ストップ高を記録したか、否かを表すフラグ
	// MorningLowerLimit         string  `json:"MLL"`       // 前場ストップ安を記録したか、否かを表すフラグ
	// MorningVolume             string  `json:"MVo"`       // 前場売買高
	// MorningTurnoverValue      string  `json:"MVa"`       // 前場取引代金
	// MorningAdjustmentOpen     string  `json:"MAdjO"`     // 調整済み前場始値
	// MorningAdjustmentHigh     string  `json:"MAdjH"`     // 調整済み前場高値
	// MorningAdjustmentLow      string  `json:"MAdjL"`     // 調整済み前場安値
	// MorningAdjustmentClose    string  `json:"MAdjC"`     // 調整済み前場終値
	// MorningAdjustmentVolume   string  `json:"MAdjVo"`    // 調整済み前場売買高
	// AfternoonOpen             string  `json:"AO"`        // 後場始値
	// AfternoonHigh             string  `json:"AH"`        // 後場高値
	// AfternoonLow              string  `json:"AL"`        // 後場安値
	// AfternoonClose            string  `json:"AC"`        // 後場終値
	// AfternoonUpperLimit       string  `json:"AUL"`       // 後場ストップ高を記録したか、否かを表すフラグ
	// AfternoonLowerLimit       string  `json:"ALL"`       // 後場ストップ安を記録したか、否かを表すフラグ
	// AfternoonVolume           string  `json:"AVo"`       // 後場売買高
	// AfternoonTurnoverValue    string  `json:"AVa"`       // 後場取引代金
	// AfternoonAdjustmentOpen   string  `json:"AAdjO"`     // 調整済み後場始値
	// AfternoonAdjustmentHigh   string  `json:"AAdjH"`     // 調整済み後場高値
	// AfternoonAdjustmentLow    string  `json:"AAdjL"`     // 調整済み後場安値
	// AfternoonAdjustmentClose  string  `json:"AAdjC"`     // 調整済み後場終値
	// AfternoonAdjustmentVolume string  `json:"AAdjVo"`    // 調整済み後場売買高
}
